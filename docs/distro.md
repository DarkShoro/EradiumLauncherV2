...
You can use [Nebula](https://github.com/DarkShoro/Nebula) to automate the generation of a distribution index.

The most up to date and accurate descriptions of the distribution spec can be viewed in [helios-distribution-types](https://github.com/DarkShoro/helios-distribution-types).
